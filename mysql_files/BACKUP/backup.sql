...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_SALES_INVOICE`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN SALES_INVOICE_NUM_PARAM VARCHAR(10), IN SALES_INVOICE_DATE_PARAM DATE, IN SALES_INVOICE_DESC_PARAM VARCHAR(255), IN GL_ACC_NUM_PARAM INT, IN SALES_INVOICE_NUM_OLD_PARAM VARCHAR(10), IN SALES_INVOICELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
