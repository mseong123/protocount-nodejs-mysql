...
INSERT INTO `bank_receipt` VALUES ('BR-3','BANK-3',NULL,'2018-03-01','CHEQUE','MBB001','INITIAL CASH INFUSION FROM OWNER',500000.00,100),('BR-4','BANK-2','DEB-2','2019-03-01','CHEQUE','OCBC0282',NULL,275.00,NULL),('BR-5','BANK-2','DEB-2','2020-03-03',NULL,NULL,NULL,500.00,NULL);
...
INSERT INTO `debit_note` VALUES ('DN-1','2020-03-03',NULL,'45','DEB-1',500);
...
INSERT INTO `debit_noteline` (`DEBIT_NOTE_NUM`, `DEBIT_NOTELINE_LINENUMBER`, `DEBIT_NOTELINE_STOCK_NUM`, `DEBIT_NOTELINE_STOCK_DESC`, `DEBIT_NOTELINE_STOCK_PRICE`, `DEBIT_NOTELINE_STOCK_QTY`, `DEBIT_NOTELINE_DISCOUNT`) VALUES ('DN-1',1,'FBUM-1','EXORA FRONT BUMPER',55.00,20,0.00),('DN-1',2,'FSKI-1','EXORA FRONT SKIRT',35.00,10,0.00);
...
INSERT INTO `purchase_credit_note` VALUES ('PCN-2','2020-01-28','CN FROM MARS PAINT FOR BEING JACKASS!','COD','CRED-1',610);
...
INSERT INTO `sales_invoice` VALUES ('PRO-1','2020-01-31',NULL,'60','DEB-3',500),('PRO-2','2020-02-29',NULL,'60','DEB-3',500),('SIPR-1','2020-03-02',NULL,'60','DEB-1',500),('TSP-1','2020-01-01',NULL,'30','DEB-2',500),('TSP-10','2020-02-06',NULL,'30','DEB-2',500),('TSP-11','2020-02-29',NULL,'30','DEB-2',500),('TSP-2','2020-01-03',NULL,'30','DEB-2',500),('TSP-3','2020-01-07',NULL,'30','DEB-2',500),('TSP-4','2020-01-09',NULL,'30','DEB-2',500),('TSP-5','2020-01-16',NULL,'30','DEB-2',500),('TSP-6','2020-01-20',NULL,'30','DEB-2',500),('TSP-7','2020-01-28',NULL,'30','DEB-2',500),('TSP-8','2020-03-27',NULL,'30','DEB-2',500),('TSP-9','2020-02-01',NULL,'30','DEB-2',500);
...
INSERT INTO `sales_invoice_bank_receipt` VALUES ('BR-4','TSP-2',275.00),('BR-5','TSP-3',500.00);
...
INSERT INTO `sales_invoice_cash_receipt` VALUES ('CR-5','PRO-2','100'),('CR-4','SIPR-1','300'),('CR-3','TSP-2','275');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_CREDIT_NOTE`(IN DEBTOR_NUM_PARAM VARCHAR(20), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN CREDIT_NOTE_NUM_PARAM VARCHAR(20), IN CREDIT_NOTE_DATE_PARAM DATE, IN CREDIT_NOTE_DESC_PARAM VARCHAR(255), IN CREDIT_NOTE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, IN CREDIT_NOTE_NUM_OLD_PARAM VARCHAR(20), IN CREDIT_NOTELINE_PARAM VARCHAR(255), IN OFFSET_ONE_PARAM VARCHAR(255),IN OFFSET_TWO_PARAM VARCHAR(255))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_PURCHASE_RETURN`(IN CREDITOR_NUM_PARAM VARCHAR(20), IN CREDITOR_NAME_PARAM VARCHAR(255),IN CREDITOR_ADDRESS_PARAM VARCHAR(255), IN PURCHASE_RETURN_NUM_PARAM VARCHAR(20), IN PURCHASE_RETURN_DATE_PARAM DATE, IN PURCHASE_RETURN_DESC_PARAM VARCHAR(255), IN PURCHASE_RETURN_NUM_OLD_PARAM VARCHAR(20), IN PURCHASE_RETURNLINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_STOCK`(IN STOCK_NUM_PARAM VARCHAR(20),IN STOCK_DESC_PARAM VARCHAR(255), IN STOCK_PRICE_PARAM DEC(10,2), IN STOCK_MINPRICE_PARAM DEC(10,2), IN STOCK_MAXPRICE_PARAM DEC(10,2),IN STOCK_COST_PARAM DEC(10,2),IN STOCK_MINQTY_PARAM INT,IN STOCK_MAXQTY_PARAM INT,IN STOCK_BALQTY_PARAM INT,IN STOCK_NUM_OLD_PARAM VARCHAR(20))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_CREDIT_NOTE`(IN DEBTOR_NUM_PARAM VARCHAR(20), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN CREDIT_NOTE_NUM_PARAM VARCHAR(20), IN CREDIT_NOTE_DATE_PARAM DATE, IN CREDIT_NOTE_DESC_PARAM VARCHAR(255), IN CREDIT_NOTE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, CREDIT_NOTE_NUM_OLD_PARAM VARCHAR(20), IN CREDIT_NOTELINE_PARAM VARCHAR(255), IN OFFSET_ONE_PARAM VARCHAR(255), IN OFFSET_TWO_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE POS1 INT DEFAULT 1;
DECLARE POS2 INT DEFAULT 1;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_STOCK`(IN STOCK_NUM_PARAM VARCHAR(20),IN STOCK_DESC_PARAM VARCHAR(255), IN STOCK_PRICE_PARAM DEC(10,2), IN STOCK_MINPRICE_PARAM DEC(10,2), IN STOCK_MAXPRICE_PARAM DEC(10,2),IN STOCK_COST_PARAM DEC(10,2),IN STOCK_MINQTY_PARAM INT,IN STOCK_MAXQTY_PARAM INT,IN STOCK_BALQTY_PARAM INT, IN STOCK_NUM_OLD_PARAM VARCHAR(20))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
-- Dump completed on 2020-03-30 20:41:32
