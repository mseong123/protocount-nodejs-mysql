...
INSERT INTO `credit_note_stock` VALUES ('CN-2',2,'FBUM-1',5),('CN-3',1,'FBUM-1',6),('CN-3',2,'SPR-1',7),('CN-4',1,'FSKI-1',7);
...
INSERT INTO `debit_note_stock` VALUES ('DN-1',1,'FBUM-1',20),('DN-1',2,'FSKI-1',10),('DN-3',1,'FBUM-1',7),('DN-3',2,'FBUM-1',2),('DN-3',3,'FSKI-1',1);
...
INSERT INTO `delivery_order` VALUES ('DO-3','2020-04-07',NULL,'DEB-6'),('DO-4','2020-04-07',NULL,'DEB-1');
...
INSERT INTO `delivery_order_stock` VALUES ('DO-3',1,'FBUM-1',13),('DO-3',2,'FSKI-1',5),('DO-4',1,'FBUM-1',2),('DO-4',2,'FBUM-1',3);
...
INSERT INTO `delivery_orderline` VALUES ('DO-3',1,'FBUM-1','EXORA FRONT BUMPER',13),('DO-3',2,'FSKI-1','EXORA FRONT SKIRT',5),('DO-4',1,'FBUM-1','EXORA FRONT BUMPER',2),('DO-4',2,'FBUM-1','EXORA FRONT BUMPER',3);
...
INSERT INTO `sales_invoice` VALUES ('PRO-1','2020-01-31',NULL,'60','DEB-3',500),('PRO-2','2020-02-29',NULL,'COD','DEB-3',500),('SIPR-1','2020-03-02',NULL,'60','DEB-1',500),('TSP-1','2019-12-31',NULL,'30','DEB-2',500),('TSP-10','2020-02-06',NULL,'30','DEB-2',500),('TSP-11','2020-02-29',NULL,'60','DEB-2',500),('TSP-2','2020-01-03',NULL,'30','DEB-2',500),('TSP-3','2020-01-07',NULL,'30','DEB-2',500),('TSP-4','2020-01-09',NULL,'30','DEB-2',500),('TSP-5','2020-01-16',NULL,'30','DEB-2',500),('TSP-6','2020-01-20',NULL,'30','DEB-2',500),('TSP-8','2020-03-01',NULL,'30','DEB-2',500),('TSP-9','2020-02-01',NULL,'30','DEB-2',500);
...
INSERT INTO `sales_invoice_stock` VALUES ('PRO-1',1,'SPR-1',10),('PRO-1',2,'FSKI-1',10),('PRO-1',3,'FBUM-1',10),('PRO-1',4,'FBUM-1',10),('TSP-1',1,'SPR-1',4),('TSP-2',2,'FSKI-1',4);
...
INSERT INTO `stock` VALUES ('FBUM-1','EXORA FRONT BUMPER',55.00,NULL,NULL,1.00,NULL,NULL),('FSKI-1','EXORA FRONT SKIRT',35.00,NULL,NULL,NULL,NULL,NULL),('SPR-1','SPOILER',25.00,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `stock_adjustment` (
  `STOCK_ADJUSTMENT_NUM` varchar(20) NOT NULL,
  `STOCK_ADJUSTMENT_DATE` date NOT NULL,
  `STOCK_ADJUSTMENT_DESC` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`STOCK_ADJUSTMENT_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `stock_adjustment` VALUES ('adj-1','2020-04-02','123'),('adj-2','2020-04-07',NULL);
/*!40000 ALTER TABLE `stock_adjustment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `stock_adjustmentline`
--

DROP TABLE IF EXISTS `stock_adjustmentline`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_adjustmentline` (
  `STOCK_ADJUSTMENT_NUM` varchar(20) NOT NULL,
  `STOCK_ADJUSTMENTLINE_LINENUMBER` int(11) NOT NULL,
  `STOCK_NUM` varchar(20) NOT NULL,
  `STOCK_ADJUSTMENTLINE_STOCK_DESC` varchar(50) NOT NULL,
  `STOCK_ADJUSTMENTLINE_STOCK_QTY` int(11) NOT NULL,
  PRIMARY KEY (`STOCK_ADJUSTMENT_NUM`,`STOCK_ADJUSTMENTLINE_LINENUMBER`),
  KEY `fk_STOCK_ADJUSTMENTLINE_STOCK_ADJUSTMENT1_idx` (`STOCK_ADJUSTMENT_NUM`),
  KEY `fk_STOCK_ADJUSTMENTLINE_STOCK1_idx` (`STOCK_NUM`),
  CONSTRAINT `fk_STOCK_ADJUSTMENTLINE_STOCK1` FOREIGN KEY (`STOCK_NUM`) REFERENCES `stock` (`STOCK_NUM`),
  CONSTRAINT `fk_STOCK_ADJUSTMENTLINE_STOCK_ADJUSTMENT1` FOREIGN KEY (`STOCK_ADJUSTMENT_NUM`) REFERENCES `stock_adjustment` (`STOCK_ADJUSTMENT_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stock_adjustmentline`
--

LOCK TABLES `stock_adjustmentline` WRITE;
/*!40000 ALTER TABLE `stock_adjustmentline` DISABLE KEYS */;
INSERT INTO `stock_adjustmentline` VALUES ('adj-1',1,'FBUM-1','EXORA FRONT BUMPER',-5),('adj-2',1,'SPR-1','SPOILER',20),('adj-2',2,'FSKI-1','EXORA FRONT SKIRT',-1);
/*!40000 ALTER TABLE `stock_adjustmentline` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `DELETE_STOCK_ADJUSTMENT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `INSERT_STOCK_ADJUSTMENT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_STOCK_ADJUSTMENT`(IN STOCK_ADJUSTMENT_NUM_PARAM VARCHAR(20), IN STOCK_ADJUSTMENT_DATE_PARAM DATE, IN STOCK_ADJUSTMENT_DESC_PARAM VARCHAR(255), IN STOCK_ADJUSTMENT_NUM_OLD_PARAM VARCHAR(20), IN STOCK_ADJUSTMENTLINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
INSERT stock_adjustment VALUES(STOCK_ADJUSTMENT_NUM_PARAM,STOCK_ADJUSTMENT_DATE_PARAM,STOCK_ADJUSTMENT_DESC_PARAM);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_CREDITOR_AGING` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_CREDITOR_STATEMENT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_PURCHASE_ANALYSIS_CREDITOR_STOCK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_PURCHASE_ANALYSIS_STOCK_CREDITOR` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_PURCHASE_ANALYSIS_STOCK_CREDITOR`(IN DATE_START_PARAM VARCHAR(255), IN DATE_END_PARAM VARCHAR(255), IN STOCK_NUM_PARAM VARCHAR(255),IN CREDITOR_NUM_PARAM VARCHAR(255))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
SELECT CONCAT("SELECT PURCHASE_INVOICELINE_STOCK_NUM AS 'STOCK NUM',(SELECT STOCK_DESC FROM stock WHERE STOCK_NUM = PURCHASE_INVOICELINE_STOCK_NUM) AS 'STOCK DESC',PURCHASE_INVOICE_DATE AS DATE,SUM(PURCHASE_INVOICELINE_STOCK_QTY) AS QTY,SUM(PURCHASE_INVOICELINE_SUBTOTAL) AS SUBTOTAL FROM purchase_invoice NATURAL JOIN purchase_invoiceline WHERE PURCHASE_INVOICELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_INVOICE_DATE>=",DATE_START_PARAM," AND PURCHASE_INVOICE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_INVOICELINE_STOCK_NUM,PURCHASE_INVOICE_NUM
UNION ALL (SELECT PURCHASE_DEBIT_NOTELINE_STOCK_NUM,(SELECT STOCK_DESC FROM stock WHERE STOCK_NUM = PURCHASE_DEBIT_NOTELINE_STOCK_NUM),PURCHASE_DEBIT_NOTE_DATE,SUM(PURCHASE_DEBIT_NOTELINE_STOCK_QTY),SUM(PURCHASE_DEBIT_NOTELINE_SUBTOTAL) FROM purchase_debit_note NATURAL JOIN purchase_debit_noteline WHERE PURCHASE_DEBIT_NOTELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_DEBIT_NOTE_DATE>=",DATE_START_PARAM," AND PURCHASE_DEBIT_NOTE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_DEBIT_NOTELINE_STOCK_NUM,PURCHASE_DEBIT_NOTE_NUM)
UNION ALL (SELECT PURCHASE_CREDIT_NOTELINE_STOCK_NUM,(SELECT STOCK_DESC FROM stock WHERE STOCK_NUM = PURCHASE_CREDIT_NOTELINE_STOCK_NUM),PURCHASE_CREDIT_NOTE_DATE,-SUM(PURCHASE_CREDIT_NOTELINE_STOCK_QTY),-SUM(PURCHASE_CREDIT_NOTELINE_SUBTOTAL) FROM purchase_credit_note NATURAL JOIN purchase_credit_noteline WHERE PURCHASE_CREDIT_NOTELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_CREDIT_NOTE_DATE>=",DATE_START_PARAM," AND PURCHASE_CREDIT_NOTE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_CREDIT_NOTELINE_STOCK_NUM,PURCHASE_CREDIT_NOTE_NUM)
ORDER BY 'STOCK NUM',DATE") INTO @STRNG;
...
SELECT CONCAT("SELECT PURCHASE_INVOICELINE_STOCK_NUM AS 'STOCK NUM',CREDITOR_NUM,CREDITOR_NAME,PURCHASE_INVOICE_DATE AS DATE, SUM(PURCHASE_INVOICELINE_STOCK_QTY) AS QTY,SUM(PURCHASE_INVOICELINE_SUBTOTAL) AS SUBTOTAL FROM creditor JOIN purchase_invoice USING (CREDITOR_NUM) NATURAL JOIN purchase_invoiceline WHERE CREDITOR_NUM IN (",CREDITOR_NUM_PARAM,") AND PURCHASE_INVOICELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_INVOICE_DATE>=",DATE_START_PARAM," AND PURCHASE_INVOICE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_INVOICELINE_STOCK_NUM,PURCHASE_INVOICE_NUM
UNION ALL (SELECT PURCHASE_DEBIT_NOTELINE_STOCK_NUM,CREDITOR_NUM,CREDITOR_NAME,PURCHASE_DEBIT_NOTE_DATE,SUM(PURCHASE_DEBIT_NOTELINE_STOCK_QTY),SUM(PURCHASE_DEBIT_NOTELINE_SUBTOTAL) FROM creditor JOIN purchase_debit_note USING (CREDITOR_NUM) NATURAL JOIN purchase_debit_noteline WHERE CREDITOR_NUM IN (",CREDITOR_NUM_PARAM,") AND PURCHASE_DEBIT_NOTELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_DEBIT_NOTE_DATE>=",DATE_START_PARAM," AND PURCHASE_DEBIT_NOTE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_DEBIT_NOTELINE_STOCK_NUM,PURCHASE_DEBIT_NOTE_NUM) 
UNION ALL (SELECT PURCHASE_CREDIT_NOTELINE_STOCK_NUM,CREDITOR_NUM,CREDITOR_NAME,PURCHASE_CREDIT_NOTE_DATE,-SUM(PURCHASE_CREDIT_NOTELINE_STOCK_QTY),-SUM(PURCHASE_CREDIT_NOTELINE_SUBTOTAL) FROM creditor JOIN purchase_credit_note USING (CREDITOR_NUM) NATURAL JOIN purchase_credit_noteline WHERE CREDITOR_NUM IN (",CREDITOR_NUM_PARAM,") AND PURCHASE_CREDIT_NOTELINE_STOCK_NUM IN (",STOCK_NUM_PARAM,") AND PURCHASE_CREDIT_NOTE_DATE>=",DATE_START_PARAM," AND PURCHASE_CREDIT_NOTE_DATE<=",DATE_END_PARAM," GROUP BY PURCHASE_CREDIT_NOTELINE_STOCK_NUM,PURCHASE_CREDIT_NOTE_NUM) 
ORDER BY CREDITOR_NUM,DATE") INTO @STRNG;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_SALES_ANALYSIS_DEBTOR_STOCK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_SALES_ANALYSIS_STOCK_DEBTOR` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_STOCK_ADJUSTMENT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_STOCK_ADJUSTMENTLIST` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SELECT_STOCK_CARD` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UPDATE_STOCK_ADJUSTMENT` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-05-01 13:28:17
