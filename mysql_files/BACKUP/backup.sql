...
INSERT INTO `credit_note` VALUES ('CN-1','2020-01-31','DISCOUNT','DEB-3',560),('CN-2','2020-03-03','Another discount','DEB-2',550),('CN-3','2020-03-03',NULL,'DEB-3',550);
...
INSERT INTO `debit_note` VALUES ('DN-1','2020-01-28','UNDERCHARGED SALES + SOMETHING','30','DEB-3',500),('DN-2','2020-03-03',NULL,'COD','DEB-1',500);
...
INSERT INTO `delivery_order` VALUES ('DO-1','2020-02-04','FIRST DELIVERY!','DEB-1'),('DO-2','2020-03-03','second','DEB-2');
...
INSERT INTO `delivery_orderline` VALUES ('DO-1',1,'BUM-1','EXORA BUMPER',5),('DO-1',2,'X70-1','X70 BUMPER',10),('DO-2',1,'SPL-1','EXORA SPOILER',6);
...
INSERT INTO `journalline` VALUES ('JNL-1',1,320,'CASH IN HAND',NULL,500.00,NULL),('JNL-2',1,205,'ACCUM DEPRECIATION-FURNITURES AND FITTINGS',NULL,NULL,300.00),('JNL-1',2,320,'CASH IN HAND',NULL,NULL,500.00),('JNL-2',2,903,'DEPRECIATION OF FIXED ASSETS',NULL,300.00,NULL);
...
INSERT INTO `purchase_debit_note` VALUES ('MARS-DN-124','2020-03-03',NULL,'COD','CRED-1',615);
...
INSERT INTO `purchase_invoice` VALUES ('INV-043511','2019-12-03','ADS','45','CRED-1',610),('INV-6571','2019-12-04',NULL,'COD','CRED-2',610),('ROT-02','2020-03-03',NULL,'COD','CRED-2',610);
...
INSERT INTO `sales_invoice` VALUES ('SIPR-1','2020-01-02',NULL,'60','DEB-1',500),('SIPR-2','2020-01-03','M','COD','DEB-1',510),('TSP-1','2019-01-31',NULL,'30','DEB-2',500),('TSP-3','2020-03-10',NULL,'COD','DEB-2',500);
...
INSERT INTO `sales_invoice_credit_note` VALUES ('CN-2','TSP-1',220.00);
...
INSERT INTO `sales_invoiceline` (`SALES_INVOICE_NUM`, `SALES_INVOICELINE_LINENUMBER`, `SALES_INVOICELINE_STOCK_NUM`, `SALES_INVOICELINE_STOCK_DESC`, `SALES_INVOICELINE_STOCK_PRICE`, `SALES_INVOICELINE_STOCK_QTY`, `SALES_INVOICELINE_DISCOUNT`) VALUES ('SIPR-1',1,'BUM-1','EXORA BUMPER ',555.00,5,1.50),('SIPR-1',2,'FSKI-1','EXORA FRONT SKIRT',35.00,5,5.00),('SIPR-1',3,'SPL-1','EXORA SPOILER',25.00,5,0.00),('SIPR-2',1,'FSKI-1','EXORA FRONT SKIRT',1000.00,5,5.00),('SIPR-2',2,'SPL-1','EXORA SPOILER',25.00,5,5.00),('TSP-1',1,'BUM-1','EXORA BUMPER5',55.00,4,0.00),('TSP-3',1,NULL,'discount',500.00,1,0.00);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_DEBIT_NOTE`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255),IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN DEBIT_NOTE_NUM_PARAM VARCHAR(10), IN DEBIT_NOTE_DATE_PARAM DATE, IN DEBIT_NOTE_DESC_PARAM VARCHAR(255), IN DEBIT_NOTE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, IN DEBIT_NOTE_NUM_OLD_PARAM VARCHAR(10), IN DEBIT_NOTELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_DEBTOR`(IN DEBTOR_NUM_PARAM VARCHAR(10),IN DEBTOR_NAME_PARAM VARCHAR(255), IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN DEBTOR_POSTCODE_PARAM VARCHAR(5), IN DEBTOR_PHONE_PARAM VARCHAR(15),IN DEBTOR_FAX_PARAM VARCHAR(15),IN DEBTOR_OTHER_DESC_PARAM VARCHAR(255),IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD', '30', '45', '60', '90'),IN GL_ACC_NUM_PARAM INT,IN DEBTOR_NUM_OLD_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_DELIVERY_ORDER`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN DELIVERY_ORDER_NUM_PARAM VARCHAR(10), IN DELIVERY_ORDER_DATE_PARAM DATE, IN DELIVERY_ORDER_DESC_PARAM VARCHAR(255), IN DELIVERY_ORDER_NUM_OLD_PARAM VARCHAR(10), IN DELIVERY_ORDERLINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `INSERT_SALES_INVOICE`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN SALES_INVOICE_NUM_PARAM VARCHAR(10), IN SALES_INVOICE_DATE_PARAM DATE, IN SALES_INVOICE_DESC_PARAM VARCHAR(255), IN SALES_INVOICE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'),IN GL_ACC_NUM_PARAM INT, IN SALES_INVOICE_NUM_OLD_PARAM VARCHAR(10), IN SALES_INVOICELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_BANK`(IN BANK_NUM_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_CREDITOR`(IN CREDITOR_NUM_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
END;
START TRANSACTION;
SELECT CREDIT_NOTE_NUM,DEBTOR_NAME,CREDIT_NOTE_DATE,CREDIT_NOTE_DESC, SUM(CREDIT_NOTELINE_SUBTOTAL) AS CREDIT_NOTE_SUBTOTAL FROM debtor JOIN credit_note USING(DEBTOR_NUM) LEFT JOIN credit_noteline USING (CREDIT_NOTE_NUM) GROUP BY CREDIT_NOTE_NUM ORDER BY CREDIT_NOTE_NUM;
COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_DEBIT_NOTE`(IN DEBIT_NOTE_NUM_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
END;
START TRANSACTION;
SELECT DEBTOR_NUM, DEBTOR_NAME, DEBTOR_ADDRESS, DEBTOR_CREDIT_TERM, DEBIT_NOTE_NUM,DEBIT_NOTE_DATE,DEBIT_NOTE_DESC,DEBIT_NOTE_CREDIT_TERM, debit_note.GL_ACC_NUM, DEBIT_NOTE_NUM AS DEBIT_NOTE_NUM_OLD FROM debtor JOIN debit_note USING (DEBTOR_NUM) WHERE DEBIT_NOTE_NUM=DEBIT_NOTE_NUM_PARAM;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_DELIVERY_ORDER`(IN DELIVERY_ORDER_NUM_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
END;
START TRANSACTION;
SELECT CREDITOR_NUM,CREDITOR_NAME,CREDITOR_ADDRESS,CREDITOR_CREDIT_TERM,PURCHASE_INVOICE_NUM,PURCHASE_INVOICE_DATE,PURCHASE_INVOICE_DESC,PURCHASE_INVOICE_CREDIT_TERM,purchase_invoice.GL_ACC_NUM,PURCHASE_INVOICE_NUM AS PURCHASE_INVOICE_NUM_OLD FROM creditor JOIN purchase_invoice USING (CREDITOR_NUM) WHERE PURCHASE_INVOICE_NUM=PURCHASE_INVOICE_NUM_PARAM;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `SELECT_SALES_INVOICE`(IN SALES_INVOICE_NUM_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
END;
START TRANSACTION;
SELECT DEBTOR_NUM, DEBTOR_NAME, DEBTOR_ADDRESS, DEBTOR_CREDIT_TERM, SALES_INVOICE_NUM,SALES_INVOICE_DATE,SALES_INVOICE_DESC, SALES_INVOICE_CREDIT_TERM,sales_invoice.GL_ACC_NUM, SALES_INVOICE_NUM AS SALES_INVOICE_NUM_OLD FROM debtor JOIN sales_invoice USING (DEBTOR_NUM) WHERE SALES_INVOICE_NUM=SALES_INVOICE_NUM_PARAM;
...
END;
START TRANSACTION;
SELECT SALES_INVOICE_NUM,DEBTOR_NAME,SALES_INVOICE_DATE,SALES_INVOICE_DESC, SUM(SALES_INVOICELINE_SUBTOTAL) AS SALES_INVOICE_SUBTOTAL FROM debtor JOIN sales_invoice USING(DEBTOR_NUM) LEFT JOIN sales_invoiceline USING (SALES_INVOICE_NUM) GROUP BY SALES_INVOICE_NUM ORDER BY SALES_INVOICE_NUM;
COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_BANK`(IN BANK_NUM_PARAM VARCHAR(10),IN BANK_NAME_PARAM VARCHAR(255), IN BANK_ADDRESS_PARAM VARCHAR(255), IN BANK_POSTCODE_PARAM VARCHAR(5),IN GL_ACC_NUM_PARAM INT,IN BANK_NUM_OLD_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_DEBIT_NOTE`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255),IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN DEBIT_NOTE_NUM_PARAM VARCHAR(10), IN DEBIT_NOTE_DATE_PARAM DATE, IN DEBIT_NOTE_DESC_PARAM VARCHAR(255), IN DEBIT_NOTE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, DEBIT_NOTE_NUM_OLD_PARAM VARCHAR(10), IN DEBIT_NOTELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_DEBTOR`(IN DEBTOR_NUM_PARAM VARCHAR(10),IN DEBTOR_NAME_PARAM VARCHAR(255), IN DEBTOR_ADDRESS_PARAM VARCHAR(255), IN DEBTOR_POSTCODE_PARAM VARCHAR(5), IN DEBTOR_PHONE_PARAM VARCHAR(15),IN DEBTOR_FAX_PARAM VARCHAR(15),IN DEBTOR_OTHER_DESC_PARAM VARCHAR(255),IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD', '30', '45', '60', '90'),IN GL_ACC_NUM_PARAM INT,IN DEBTOR_NUM_OLD_PARAM VARCHAR(10))
BEGIN
DECLARE EXIT HANDLER FOR SQLEXCEPTION
BEGIN
ROLLBACK;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_JOURNAL`(IN JOURNAL_NUM_PARAM VARCHAR(10), IN JOURNAL_DATE_PARAM DATE,IN JOURNAL_DESC_PARAM VARCHAR(255), IN JOURNAL_NUM_OLD_PARAM VARCHAR(10), IN JOURNALLINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_PURCHASE_DEBIT_NOTE`(IN CREDITOR_NUM_PARAM VARCHAR(10), IN CREDITOR_NAME_PARAM VARCHAR(255),IN CREDITOR_ADDRESS_PARAM VARCHAR(255), IN CREDITOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'),IN PURCHASE_DEBIT_NOTE_NUM_PARAM VARCHAR(50), IN PURCHASE_DEBIT_NOTE_DATE_PARAM DATE, IN PURCHASE_DEBIT_NOTE_DESC_PARAM VARCHAR(255), IN PURCHASE_DEBIT_NOTE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'),IN GL_ACC_NUM_PARAM INT, PURCHASE_DEBIT_NOTE_NUM_OLD_PARAM VARCHAR(50), IN PURCHASE_DEBIT_NOTELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_PURCHASE_INVOICE`(IN CREDITOR_NUM_PARAM VARCHAR(10), IN CREDITOR_NAME_PARAM VARCHAR(255),IN CREDITOR_ADDRESS_PARAM VARCHAR(255),IN CREDITOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'),IN PURCHASE_INVOICE_NUM_PARAM VARCHAR(50), IN PURCHASE_INVOICE_DATE_PARAM DATE, IN PURCHASE_INVOICE_DESC_PARAM VARCHAR(255),IN PURCHASE_INVOICE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, IN PURCHASE_INVOICE_NUM_OLD_PARAM VARCHAR(50), IN PURCHASE_INVOICELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `UPDATE_SALES_INVOICE`(IN DEBTOR_NUM_PARAM VARCHAR(10), IN DEBTOR_NAME_PARAM VARCHAR(255),IN DEBTOR_ADDRESS_PARAM VARCHAR(255),IN DEBTOR_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN SALES_INVOICE_NUM_PARAM VARCHAR(10), IN SALES_INVOICE_DATE_PARAM DATE, IN SALES_INVOICE_DESC_PARAM VARCHAR(255), IN SALES_INVOICE_CREDIT_TERM_PARAM ENUM('COD','30','45','60','90'), IN GL_ACC_NUM_PARAM INT, SALES_INVOICE_NUM_OLD_PARAM VARCHAR(10), IN SALES_INVOICELINE_PARAM VARCHAR(255))
BEGIN
DECLARE POS INT DEFAULT 1;
DECLARE LENGTH INT DEFAULT 0;
DECLARE DONE VARCHAR(20) DEFAULT 'NO';
...
-- Dump completed on 2020-03-21 17:25:57
